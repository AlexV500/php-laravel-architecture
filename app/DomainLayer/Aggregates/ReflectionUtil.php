...
class ReflectionUtil
{
     ...
     * @param $propertyName
     * @return null|string
     * @throws IDesoftConfigurationException
     */
    public static function getPropertyClass($class, $propertyName)
    {
        if ($class == get_class(new IDesoftEntity())) {
            // Make it generic if IDesoftEntity is used for generating this
            return get_class(new IDesoftEntity());
        }
        ...
        if (isset($param)) {
            ...
            throw new IDesoftConfigurationException("Getter function for '$propertyName' in '$class' class should have a proper return type.");
        }
    }
